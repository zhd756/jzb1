<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:64:"D:\Visual-NMP-x64\www\jzb/application/index\view\news\index.html";i:1558024371;s:66:"D:\Visual-NMP-x64\www\jzb\application\index\view\common\other.html";i:1558067953;s:67:"D:\Visual-NMP-x64\www\jzb\application\index\view\common\header.html";i:1558086027;s:67:"D:\Visual-NMP-x64\www\jzb\application\index\view\common\crumbs.html";i:1558067982;s:72:"D:\Visual-NMP-x64\www\jzb\application\index\view\common\subject_top.html";i:1558004797;s:74:"D:\Visual-NMP-x64\www\jzb\application\index\view\common\content_right.html";i:1558004797;s:75:"D:\Visual-NMP-x64\www\jzb\application\index\view\common\subject_bottom.html";i:1558002849;s:67:"D:\Visual-NMP-x64\www\jzb\application\index\view\common\footer.html";i:1558094681;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<article class="blog-wrap">
    ...
    <div class="blog-article hentry format-image">
        <figure>
            <a class="swipebox-x" href="<?php echo url('index/news/info',['id'=>$value['id']]); ?>">
                <img class="img-responsive" alt="<?php echo $value['title']; ?>" src="<?php echo $value['img']; ?>">
            </a>
        </figure>
        <div class="entry-summary post-summary">
            <header class="entry-header">
                <h2 class="entry-title post-title"><a href="<?php echo url('index/news/info',['id'=>$value['id']]); ?>" title="<?php echo $value['title']; ?>"><?php echo $value['title']; ?></a></h2>
            </header>
            <div class="entry-meta post-meta">
                <ul>
                    <li class="entry-date date">
                        <time class="entry-date" datetime="2019-02-25"><?php echo $value['create_time']; ?></time>
                    </li>
                    <li class="tags"><a href="<?php echo url('index/news/info',['id'=>$value['id']]); ?>">常见问题</a></li>
                    <li class="byline author vcard li-last">by <a href="javascript:void(0)" class="fn"><?php echo $value['users']; ?></a></li>
                </ul>
            </div>
            <div class="entry-content">
                <p><?php echo $value['introduce']; ?></p>
            </div>
            <a href="<?php echo url('index/news/info',['id'=>$value['id']]); ?>" class="read-more-link">查看详细</a></div>
    </div>
    <?php endforeach; ?>
